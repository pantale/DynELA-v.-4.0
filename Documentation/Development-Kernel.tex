...
%@DOC:List::sort(bool (*funct)(Type, Type) f)
%Warning :
%This area is an automatic documentation generated from the DynELA source code.
%Do not change anything in this latex file between this position and the @END keyword.
\textcolor{purple}{\textbf{List::sort(bool ($\star$funct)(Type, Type) f)}}\label{List::sort(bool (*funct)(Type, Type) f)}\index[DL]{List!sort(bool ($\star$funct)(Type, Type) f)}\\
Sort the list using a comparison function.

\begin{tcolorbox}[width=\textwidth,myArgs,tabularx={ll|R}]
(*funct) & f & Function defined in the objects to sort the elements.
\end{tcolorbox}
...
%@DOC:ListIndex::sort(bool (*funct)(Type, Type) f)
%Warning :
%This area is an automatic documentation generated from the DynELA source code.
%Do not change anything in this latex file between this position and the @END keyword.
\textcolor{purple}{\textbf{ListIndex::sort(bool ($\star$funct)(Type, Type) f)}}\label{ListIndex::sort(bool (*funct)(Type, Type) f)}\index[DL]{ListIndex!sort(bool ($\star$funct)(Type, Type) f)}\\
Sort the list using a comparison function.
...
%@DOC:ListIndex::search(long (*funct)(Type, long) f, long i)
%Warning :
%This area is an automatic documentation generated from the DynELA source code.
%Do not change anything in this latex file between this position and the @END keyword.
\textcolor{purple}{\textbf{ListIndex::search(long ($\star$funct)(Type, long) f, long i)}}\label{ListIndex::search(long (*funct)(Type, long) f, long i)}\index[DL]{ListIndex!search(long ($\star$funct)(Type, long) f, long i)}\\
Sort the list using a comparison function.
