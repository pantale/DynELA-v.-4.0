...
. The aim of v.3.0 is to provide an enhanced version of the code with enhancements concerning the constitutive laws, a new programming interface based on Python 3 formalism, along with some enhanced documentation.
...
\hspace*{1cm}\textsf{https://git.enit.fr/opantale/dynela-v.-3.0.git}
