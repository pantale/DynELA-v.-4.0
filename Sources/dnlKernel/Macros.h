...
#define dnlVonMises(s1, s2, s3, s4, s5, s6) \
  (sqrt((dnlSquare((s1) - (s2)) + dnlSquare((s1) - (s3)) + dnlSquare((s2) - (s3)) + 6 * (dnlSquare(s4) + dnlSquare(s5) + dnlSquare(s6))) / 2)) // Returns the getJ2 von-Mises stress with (s1,s2,s3) the normal stresses and (s4,s5,s6) the shear stresses : \f[ s = \frac {1}{\sqrt{2}}\sqrt{(s_{11}-s_{22})^2+(s_{22}-s_{33})^2+(s_{33}-s_{11})^2+6(s_{12}^2+s_{23}^2+s_{31}^2)}\f]
